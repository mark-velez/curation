...
#sex_at_birth_df.to_gbq(destination_table=sex_at_birth_log_table, if_exists='replace')

gender_log_table = '{SANDBOX}.{DATASET}_dc540_gender'.format(SANDBOX=SANDBOX, DATASET=DEID)
#gender_df.to_gbq(destination_table=gender_log_table, if_exists='replace')
# -
...
#person_df.to_gbq(destination_table=person_log_table, if_exists='replace', table_schema=person_schema)
